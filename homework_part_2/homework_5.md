...
Думаю, что это для логистики подойдет графовой СУБД.
- Генеалогические деревья
Т.к. генеалогические деревья имеют древовидную структуру, то оптимально подойдет NoSQL (сетевая).
